...
greenlet::refs::_BorrowedGreenlet<T, TC>& greenlet::refs::_BorrowedGreenlet<T, TC>::operator=(
...
static void GREENLET_NOINLINE(slp_restore_state_trampoline)() { switching_thread_state->slp_restore_state(); }
}
...
static PyObject* greenlet_internal_mod_init() noexcept {
	...
	try {
		...
		*/
		const NewReference c_api_object(Require(PyCapsule_New((void*)_PyGreenlet_API, "greenlet._C_API", NULL)));
...
PyMODINIT_FUNC PyInit__greenlet(void) { return greenlet_internal_mod_init(); }
