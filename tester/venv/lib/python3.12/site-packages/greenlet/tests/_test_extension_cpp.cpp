...
static void test_exception_throw_nonstd(int depth) { throw exception_t(depth); }

static void test_exception_throw_std() { throw std::runtime_error("Thrown from an extension."); }
 ...
 */
static PyObject* test_exception_switch(PyObject* UNUSED(self), PyObject* args) {
	int depth;
...
static PyObject* py_test_exception_throw_nonstd(PyObject* self, PyObject* args) {
...
static PyObject* py_test_exception_throw_std(PyObject* self, PyObject* args) {
	if (!PyArg_ParseTuple(args, ""))
		return NULL;
...
static PyObject* py_test_call(PyObject* self, PyObject* arg) {
 ...
 */
static PyObject* test_exception_switch_and_do_in_g2(PyObject* self, PyObject* args) {
...
static PyMethodDef test_methods[] = {
	{"test_exception_switch", (PyCFunction)&test_exception_switch, METH_VARARGS,
	 ...
	 "switching."},
	{"test_exception_switch_and_do_in_g2", (PyCFunction)&test_exception_switch_and_do_in_g2, METH_VARARGS,
	...
	{"test_exception_throw_nonstd", (PyCFunction)&py_test_exception_throw_nonstd, METH_VARARGS,
	 "Throws non-standard C++ exception. Calling this function directly should abort the process."},
	{"test_exception_throw_std", (PyCFunction)&py_test_exception_throw_std, METH_VARARGS,
	 "Throws standard C++ exception. Calling this function directly should abort the process."},
	{"test_call", (PyCFunction)&py_test_call, METH_O,
...
static struct PyModuleDef moduledef = {
	PyModuleDef_HEAD_INIT, "greenlet.tests._test_extension_cpp", NULL, 0, test_methods, NULL, NULL, NULL, NULL};

PyMODINIT_FUNC PyInit__test_extension_cpp(void) {
