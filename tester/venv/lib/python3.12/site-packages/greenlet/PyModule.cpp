...
static PyObject* mod_getcurrent(PyObject* UNUSED(module)) {
...
static PyObject* mod_settrace(PyObject* UNUSED(module), PyObject* args) {
...
static PyObject* mod_gettrace(PyObject* UNUSED(module)) {
...
static PyObject* mod_set_thread_local(PyObject* UNUSED(module), PyObject* args) {
	...
	if (PyArg_UnpackTuple(args, "set_thread_local", 2, 2, &key, &value)) {
		if (PyDict_SetItem(PyThreadState_GetDict(),	 // borrow
						   key, value) == 0) {
			// success
			Py_INCREF(Py_None);
			result = Py_None;
...
static PyObject* mod_get_pending_cleanup_count(PyObject* UNUSED(module)) {
...
static PyObject* mod_get_total_main_greenlets(PyObject* UNUSED(module)) {
...
static PyObject* mod_get_clocks_used_doing_optional_cleanup(PyObject* UNUSED(module)) {
...
static PyObject* mod_enable_optional_cleanup(PyObject* UNUSED(module), PyObject* flag) {
...
static PyObject* mod_get_tstate_trash_delete_nesting(PyObject* UNUSED(module)) {
...
static PyMethodDef GreenMethods[] = {
	...
	{.ml_name = "settrace", .ml_meth = (PyCFunction)mod_settrace, .ml_flags = METH_VARARGS, .ml_doc = mod_settrace_doc},
	{.ml_name = "gettrace", .ml_meth = (PyCFunction)mod_gettrace, .ml_flags = METH_NOARGS, .ml_doc = mod_gettrace_doc},
...
static const char* const copy_on_greentype[] = {"getcurrent", "error", "GreenletExit", "settrace", "gettrace", NULL};
